...
/* One-line summary of a master's variants for diagnostics, e.g.
   "426x240,640x360,1280x720! variants=3 avc-aac=2 audio=1" ("!" marks a
   codec the PSP path cannot decode). */
